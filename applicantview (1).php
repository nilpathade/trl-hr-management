...
<div class="bs-example">
    ...
    <div class="tab-content">
       	 <div class="form-group col-md-12"><b>Baics Details</b><hr/></div>	
                <div class="form-row ml-3">
                 <div class="form-group col-md-4">   
                    <label for="applicantname"> Applicant No: </label>
                ...
                <label for="urgencylevel">Urgency Level: </label>
                       <span class="titlespace"><?php echo getUrgencyLevel($applicantRow[0]['urgencylevel']); ?> days</span> 
                </div>

                <div class="form-group col-md-4">
                <label for="urgencylevel">Interest: </label>
                       <span class="titlespace"><?php echo $applicantRow[0]['interest']; ?> days</span> 
                </div>

                <div class="form-group col-md-4">
                <label for="urgencylevel">Uploaded CV: </label>
                       <span class="titlespace"><a href="<?php echo $applicantRow[0]['interest']; ?>">Resume</a></span> 
                </div>

                 <div class="form-group col-md-4">
                <label for="urgencylevel">Signature: </label>
                       <span class="titlespace"><?php echo $applicantRow[0]['signature']; ?></span> 
                </div>
				
				<div class="form-group col-md-12"> <b>Wroks Experience</b><hr/></div>
			  	<?php for($i=0;$i<count($experienceRow);$i++){ ?>
                    ...
                    <?php } ?> 
                         ...
                         <div class="form-group col-md-12"><b>Certification Detail</b><hr/></div>
                        ...
                        <div class="form-group col-md-12"><b>Intership</b><hr/></div>
                        ...
                        <span class="titlespace"> <?php echo $internshipRow[$i]['stipend'] ?></span>
                         ...
                         <?php } } ?>
                         <div class="form-group col-md-12"><b>Academic Detail</b><hr/></div>
        		...
        		<div class="form-group col-md-12"><b>Skills</b><hr/></div>
                	 <div class="form-row ml-3"> 
                        <div class="form-group col-sm-6 pl-10">
                ...
                <div class="form-group col-md-12"><b>Personal Detail</b><hr/></div>
				<div class="form-row ml-3"> 
                        <div class="form-group col-sm-6">
                ...
                <div class="form-group col-md-12"><b>Kids Detail</b><hr/></div>
