...
$resultRow = pdoQuery($regeditSql, array($sourceId, 1, 'N'));
...
<div class="container-fluid">
    <form action="sourceregistrationsubmit.php" method="post" id="fileForm" autocomplete="OFF"
