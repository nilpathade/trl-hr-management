...
$totalRoleResult = pdoQuery($roleSql, array('N', 1));
?>
<div class="conntainer-fluid">
  <?php if (!empty($message)) echo $message;   ?>
  <form action="sourceregistrationsubmit.php" method="post" id="fileForm" role="form" enctype="multipart/form-data">
    <h2 class="text-center">Source Team Registration</h2>
    <fieldset>
      ...
      <div class="row">
        ...
        <div class="mb-3 col-md-6">
          <?php $regs = md5("tlraddsourcesubmit"); ?>
